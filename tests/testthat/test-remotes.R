test_that("remotes from new repo",{
  ...
  expect_equal(git_remote_add('https://github.com/jeroen/webp', remote = 'jeroen', repo = repo), 'jeroen')
...
test_that("remotes after clone", {
  ...
  expect_equal(git_remote_add('https://github.com/jeroen/gert', remote = 'myfork', repo = repo), 'myfork')
  remotelist <- git_remote_list(repo = repo)
